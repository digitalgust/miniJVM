    ...
    public static void main(String[] args) {
        try {
            ...
            for (Field field : fields) {
                ...
                // 测试 getAnnotation()
                TestAnnotation testAnn = field.getAnnotation(TestAnnotation.class);
                if (testAnn != null) {
                ...
                SomeAnnotation simpleAnn = field.getAnnotation(SomeAnnotation.class);
                if (simpleAnn != null) {
            ...
            for (Method method : methods) {
                ...
                // 测试 getAnnotation()
                TestAnnotation testAnn = method.getAnnotation(TestAnnotation.class);
                if (testAnn != null) {
                    System.out.println("  TestAnnotation found:");
                    System.out.println("    value: " + testAnn.value());
                    System.out.println("    number: " + testAnn.number());
                ...
                SomeAnnotation simpleAnn = method.getAnnotation(SomeAnnotation.class);
                if (simpleAnn != null) {
                    System.out.println("  SomeAnnotation found");
                }
