...
if [ ! ${JAVA_HOME} ] ;then
    ...
    ${JAVA_HOME}/bin/java -cp tools/translator.jar com.ebsee.j2c.Main ../../minijvm/java/src/main/java/:../../test/minijvm_test/src/main/java/ ../app/generted/classes/ ../app/generted/c/
fi
