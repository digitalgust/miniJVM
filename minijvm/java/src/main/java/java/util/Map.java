 ...
 * for the {@link #containsKey(Object)
 * containsKey(Object key)} method says: "returns <tt>true</tt> if and only if
 * this map contains a mapping for a key <tt>k</tt> such that
 * <tt>(key==null ? k==null : key.equals(k))</tt>." This specification should
 * <i>not</i> be construed to imply that invoking <tt>Map.containsKey</tt>
 * with a non-null argument <tt>key</tt> will cause <tt>key.equals(k)</tt> to be
 * invoked for any key <tt>k</tt>. Implementations are free to implement
 * optimizations whereby the <tt>equals</tt> invocation is avoided, for example,
 * by first comparing the hash codes of the two keys. (The
...
public interface Map<K, V> {
    ...
    interface Entry<K, V> {
         ...
         * required to, throw this exception if the entry has been removed from
         * the backing map.
         */
        K getKey();
         ...
         * been removed from the backing map (by the iterator's
         ...
         * <tt>e1</tt> and <tt>e2</tt> represent the same mapping          if<pre>
         *     (e1.getKey()==null ?
         *      e2.getKey()==null : e1.getKey().equals(e2.getKey()))  &amp;&amp;
         *     (e1.getValue()==null ?
         *      e2.getValue()==null : e1.getValue().equals(e2.getValue()))
         * </pre> This ensures that the <tt>equals</tt> method works properly
         * across different implementations of the <tt>Map.Entry</tt> interface.
         *
     ...
     * @throws ClassCastException if the class of a replacement value prevents
     ...
     * }</pre>
     *
     * The default implementation does not throw NullPointerException for maps
     * that do not support null values if oldValue is null unless newValue is
     * also null.
     *
     * <p>
     * The default implementation makes no guarantees about synchronization or
     ...
     * for this {@code map}, then returning the current value or {@code null} if
     * now absent:
     *
     * <pre> {@code
     * if (map.get(key) == null) {
     ...
     * @throws NullPointerException if the specified key is null and this map
     * does not support null keys, or the mappingFunction is null
     * @throws UnsupportedOperationException if the {@code put} operation is not
     * supported by this map
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     * @throws ClassCastException if the class of the specified key or value
     ...
     * following steps for this {@code map}, then returning the current value or
     ...
     * @throws NullPointerException if the specified key is null and this map
     * does not support null keys, or the remappingFunction is null
     * @throws UnsupportedOperationException if the {@code put} operation is not
     * supported by this map
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     * @throws ClassCastException if the class of the specified key or value
     ...
     * associated with the key or, if no existing value or a null value is
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     * @throws NullPointerException if the specified key is null and this map
     * does not support null keys or the value or remappingFunction is null
     * @since 1.8
     */
