...
public class Nanovg_java_2_c {
    ...
    String[] path = {"src/main/java/org/mini/nanovg/Nanovg.java", "org_mini_nanovg_Nanovg_", "org/mini/nanovg/Nanovg", "../c/jni_nanovg.c"};
                ...
                if (line.startsWith(header)) {
                    ...
                    if (!VOID.equals(returnType)) {
                        if ("int".equals(returnType)) {
                            ...
                            returnCode = nativeReurnType + " _re_val = ";
                            if (Util.isPointer(nativeReurnType)) {
                    ...
                    for (int i = 0, nativei = 0; i < argvs.length; i++, nativei++) {
                        ...
                        if ("int".equals(argvType)) {
                        ...
                        } else if ("long[]".equals(argvType) && Util.isPointer(nativeArgvs[nativei])) {
                            varCode += "    Instance *" + argvName + " = env->localvar_getRefer(runtime->localvar, pos++);\n";
                            ...
                            //把值复制回去
                            if (!Util.isConstPointer(nativeArgvs[nativei])) {
